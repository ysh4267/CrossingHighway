...
bool SoundClass::Initialize(HWND hwnd)
{
	...
	result = LoadWaveFile("data/jump.wav", &m_secondaryBuffer1);
	if(!result)
	{
		return false;
	}
	...
	result = LoadWaveFile("data/gameover.wav", &m_secondaryBuffer3);
	if (!result)
	{
		return false;
	}
